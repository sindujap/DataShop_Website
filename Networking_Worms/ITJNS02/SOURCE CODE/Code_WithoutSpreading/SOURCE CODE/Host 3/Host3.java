...
import java.io.*;
/**
 * Summary description for Host3
 *
 */
public class Host3 extends JFrame
{
	...
	ServerSocket h1Sr;
	Socket h1acp,h1Cl;
	public static String wrm,incWrm,add,host,host1,host2,host4;
	public static int ch,ptno,j,k,d;
	public int status;
	public String drive="C:/Documents and Settings/";
	...
	public Host3()
	{
		...
		try
		{
			...
			while (true)
			{
				...
				{		
				h1acp=h1Sr.accept();
				//System.out.println("Ready Host3");
	...
	/*private void jButton1_actionPerformed(ActionEvent e)
	{
		...
		{
			status=1;
			h1Cl=new Socket("localhost",4444);
				DataOutputStream dos1=new DataOutputStream(h1Cl.getOutputStream());
				dos1.writeUTF(wname);
				dos1.writeInt(status);
				dos1.writeUTF("From Host3");
	...
	{
		System.out.println("\nRequesting Stoppage of Spreading");
		// TODO: Add any handling code here
		try
		{
			status=5;
			int port[]={4444,1111,2222};
