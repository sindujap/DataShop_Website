...
import java.io.*;
/**
 * Summary description for Host2
 *
 */
public class Host2 extends JFrame
{
	...
	ServerSocket h1Sr;
	Socket h1acp,h1Cl;
	public static String wrm,incWrm,add,host,host1,host3,host4;
	...
	public Host2()
	{
		...
		try
		{
			...
			while (true)
			{
				...
				{
				h1acp=h1Sr.accept();
				//System.out.println("Ready Host2");
	...
	/*private void jButton1_actionPerformed(ActionEvent e)
	{
		...
		{
				status=1;
				h1Cl=new Socket("localhost",3333);
				DataOutputStream dos1=new DataOutputStream(h1Cl.getOutputStream());
				dos1.writeUTF(wname);
				dos1.writeInt(status);
